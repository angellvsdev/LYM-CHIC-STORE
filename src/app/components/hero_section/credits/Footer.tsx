 ...
 return (
    <footer className="bg-gradient-to-bl from-white to-amaranth-pink-800 text-davys-gray-100 py-4 flex flex-col md:flex-row items-center md:justify-around px-2.5">
        <div className="flex flex-col items-center justify-center self-start mx-auto md:mx-0">
            <h1 className="text-2xl md:text-4xl font-black">© LYMChic Store. <p className="text-sm">Todos los derechos reservados.</p></h1>
            <p className="text-sm mx-0">Hecho con amor por <a href="https://www.instagram.com/angelleonardovs/" target="_blank" rel="noopener noreferrer" className="hover:text-amaranth-pink-500 transition-all duration-300">Angel Vera</a></p>
        </div>
